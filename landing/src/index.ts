...
<head>
  ...
  <title>WPPartner - Dịch Vụ Thiết Kế Website Chuyên Nghiệp</title>
  <meta name="description" content="WPPartner - Đội ngũ chuyên gia thiết kế website WordPress, WooCommerce. Giải pháp web toàn diện cho doanh nghiệp của bạn.">
  <style>
...
<body>
  ...
  <div class="container">
    <div class="stats">
      <div class="stat">
        ...
        <div class="label">Du an hoan thanh</div>
      </div>
      <div class="stat">
        <div class="number">98%</div>
        <div class="label">Khach hang hai long</div>
      </div>
      <div class="stat">
        <div class="number">5+</div>
        <div class="label">Nam kinh nghiem</div>
      </div>
      <div class="stat">
        <div class="number">24/7</div>
        <div class="label">Ho tro ky thuat</div>
      </div>
    </div>
  </div>
  ...
  <footer>
    <div class="container">
      <p>&copy; 2024 WPPartner. All rights reserved. Powered by Cloudflare Workers.</p>
    </div>
  </footer>
